...
<?php echo form_open('bbs_test/cbbsinsert', $attributes); ?>
...
<table border="1" bordercolor=~#525252" bgColor="#FFFFFF" cellSpacing="0" cellPadding="0" width="100%"> 
	<tr>
		...
		<td align="left"><font size="2" >
			<input type="text" id="b_name" name="b_name" size="15" value="<?php echo set_value('b_name'); ?>" />
		</font></td>
	</tr>
	...
	<tr>
		...
		<td align="left"><font size="2" >
			<input type="text" id="b_title" name="b_title" size="15" value="<?php echo set_value('b_title'); ?>" />
		</font></td>
	</tr>
	...
	<tr>
		...
		<td align="left"><font size="2" >
			<textarea cols="30" rows="5" wrap="off" id="b_main" name="b_main"><?php echo set_value('b_main'); ?></textarea>
		</font></td>
	</tr>
	...
	<tr>
		...
		<td align="left"><font size="2" >
			<input type="text" id="b_email" name="b_email" size="15" value="<?php echo set_value('b_email'); ?>" />
		</font></td>
	</tr>
	...
	<tr>
		...
		<td align="left"><font size="2" >
			<input type="text" id="b_url" name="b_url" size="20" value="<?php echo set_value('b_url'); ?>" />
		</font></td>
	</tr>
...
<?php echo form_open('bbs_test/bbsdelete', $attr); ?>
<font color="#FF0000" size="2">※記事を削除する場合はコチラから</font><br>
No. <input type="text" size="1" name="select_no" id="select_no" />  Pass: <input type="text" size="2" name="select_pass" id="select_pass" />  <input type="submit" name="del_bt" id="del_bt" value="削除" />
</form>
</div>
